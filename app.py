...
Original file is located at
    https://colab.research.google.com/drive/1plhvIfAegt1aH9p_fkwYrGFRbTOy_p1k
"""
...
# Paths
# In Colab, __file__ is not defined. Use a static path like /content/
BASE_DIR = "/content/"
DATA_PATH = os.path.join(BASE_DIR, "data.csv") # Changed from dataset.csv to data.csv as per available files
